...
function showNewUserOnScreen(user) {
  ...
  <div class="row align-items-center">
    ...
    <div class="col-md-3 text-md-right">
      ...
      <div class="btn-group">
        <button type="button" class="btn btn-outline-success" onclick="buyOne('${userId}')">Buy 1</button>
        <button type="button" class="btn btn-outline-success" onclick="buyTwo('${userId}')">Buy 2</button>
        <button type="button" class="btn btn-outline-success" onclick="buyThree('${userId}')">Buy 3</button>
